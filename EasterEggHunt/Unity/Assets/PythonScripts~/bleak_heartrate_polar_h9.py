...
def create_lsl_stream_outlet(stream_name: str):
    info = StreamInfo(name=stream_name, type='HR', channel_count=1, nominal_srate=sampling_rate, channel_format=cf_float32, source_id='E6:C9:75:A1:6C:4E')
...
async def run(address, lsl_stream_outlet: StreamOutlet):
    ...
    async with BleakClient(address) as client:
        ...
        def hr_val_handler(sender, data):
            ...
            hr_fmt, = bitstruct.unpack("b1b1b1b1b1<", data)
            if hr_fmt:
